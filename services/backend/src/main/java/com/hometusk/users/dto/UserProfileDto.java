...
public record UserProfileDto(
        ...
        @Schema(description = "Normalized email address when known") String email,
        @Schema(description = "Whether the stored email is verified") boolean emailVerified,
        @Schema(description = "Source of the current email value") String emailSource,
        @Schema(description = "When the email value last changed") Instant emailUpdatedAt,
        @Schema(description = "Whether the user is eligible for email notifications") boolean emailNotificationEligible,
    ...
    public static UserProfileDto from(User user, List<Membership> memberships) {
        ...
        return new UserProfileDto(
                ...
                user.getEmailSource().getValue(),
                user.getEmailUpdatedAt(),
                user.isEmailNotificationEligible(),
                user.getDisplayName(),
                user.getAvatarUrl(),
                householdSummaries,
                user.getCreatedAt());
