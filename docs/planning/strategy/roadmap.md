...
- Текущий рейтинг новых инициатив:
  ...
  - #5 INIT-2026Q3-native-mobile-mvp — DONE; product validation track для нативного Android/iOS клиента, push/deep links и mobile command chat без новой backend source of truth.
